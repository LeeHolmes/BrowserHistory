========================================================================
    ACTIVE TEMPLATE LIBRARY : BrowserHistory Project Overview
========================================================================

AppWizard has created this BrowserHistory project for you to use as the starting point for
...
BrowserHistory.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (BrowserHistory.h)
        GUID definitions                                (BrowserHistory_i.c)
        A type library                                  (BrowserHistory.tlb)
        Marshaling code                                 (BrowserHistory_p.c and dlldata.c)

BrowserHistory.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in BrowserHistory.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named BrowserHistory.pch and a precompiled types file named StdAfx.obj.
...
BrowserHistoryps.vcxproj
	...
	dlldata.c, BrowserHistory_i.c and BrowserHistory_p.c which are required
	to build the proxy/stub DLL.

BrowserHistoryps.vcxproj.filters
